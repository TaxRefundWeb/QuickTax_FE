export default function AddCustomerPage() {
  return (
    <div className="min-h-screen w-screen bg-white">
      {/* 중앙 정렬 래퍼 (화면 폭은 꽉, 내용만 가운데) */}
      <div className="mx-auto flex min-h-screen w-full max-w-[920px] flex-col items-center px-6 pt-24">
        ...
        <div className="w-full max-w-[520px]">
          ...
          <form className="space-y-5">
            ...
            <div className="pt-10 flex justify-end">
              <button
                type="button"
                className="h-[48px] w-[181px] rounded-md rounded-md border border-gray-200 bg-white text-base text-gray-700 shadow-sm hover:bg-gray-50"
              >
                입력완료
              </button>
            </div>
